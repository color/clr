...
def test_argtest(capsys):
    ...
    check(['1', '2'], 'a=1 b=2 c=4 d=None e=False g=True')
    check(['11', '2', '3'], 'a=11 b=2 c=3 d=None e=False g=True')
    check(['1', '2', '3', '4'], 'a=1 b=2 c=3 d=4 e=False g=True')
    check(['1', '2', '3', '4', '--e'], 'a=1 b=2 c=3 d=4 e=True g=True')
    check(['1', '2', '--c=3'], 'a=1 b=2 c=3 d=None e=False g=True')
    check(['1', '2', '--c', '3'], 'a=1 b=2 c=3 d=None e=False g=True')
    check(['1', '2', '--c=3', '--d=4'], 'a=1 b=2 c=3 d=4 e=False g=True')
    check(['1', '2', '--d=4', '--c=3'], 'a=1 b=2 c=3 d=4 e=False g=True')
    check(['1', '2', '--d=3'], 'a=1 b=2 c=4 d=3 e=False g=True')
    check(['1', '2', '--nog', '--e'], 'a=1 b=2 c=4 d=None e=True g=False')
